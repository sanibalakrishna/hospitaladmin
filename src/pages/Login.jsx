  ...
  return (
    <div className='flex flex-col h-full w-full  bg-[#0198A5] md:bg-white rounded-3xl md:flex-row md:h-[98%] md:w-[99%]'>
        <div className='w-full h-1/3  bg-[#0198A5] flex items-center justify-center rounded-3xl md:h-full md:flex-col'>
            <img src={medicare} className='w-[30%]'/>
        ...
        <ToastContainer theme="colored" />
            <div >
                <h1 className='text-center text-xl font-bold md:text-4xl'>Welcome!</h1>
                <p>Please enter your details</p>
            </div>
            
            <div className='flex flex-col gap-10 w-[70%]'>
                <div >
                <fieldset className={`border-2 hover:border-[#0198A5] rounded-lg  ${(email!="")&& 'border-[#0198A5]'}`}>
                  <legend className="ml-2.5 text-[#0198A5]" >Email</legend>
                  <div className='flex w-full gap-2 px-2'>
                  <HiOutlineMail size={20} className='text-[#0198A5]'/>
                  <input type="email" className="outline-none pl-2 w-full" value={email} onChange={(e)=>setEmail(e.target.value)}/>
                  </div>
                
                 </fieldset>
                </div>
                <div>
                 <fieldset className={`border-2 hover:border-[#0198A5] rounded-lg  ${(password!="")&& 'border-[#0198A5]'}`}>
                  <legend className="ml-2.5 text-[#0198A5]">Password</legend>
                  <div className='flex w-full gap-2 px-2'>
                  <HiOutlineLockOpen size={20} className='text-[#0198A5]'/>
                  <input type={passwordtype} className="outline-none w-full" value={password} onChange={(e)=>setPassword(e.target.value)}/>
                ...
                <button className='bg-[#0198A5] rounded-lg h-10 text-white active:scale-95' onClick={handleSignIn}>sign in</button>
